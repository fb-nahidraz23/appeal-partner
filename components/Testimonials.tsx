...
export default function Testimonials() {
  ...
  const ugcVideos = [
    {
      title: "Account Restored in 3 Days",
      customer: "Michael C.",
      business: "Electronics Store",
      embedUrl: "pqfpkp2mst",
      placeholder: "https://readdy.ai/api/search-image?query=Professional%20businessman%20in%20modern%20office%20speaking%20confidently%20to%20camera%20about%20business%20success%2C%20clean%20corporate%20background%20with%20soft%20lighting%2C%20authentic%20testimonial%20video%20style&width=300&height=600&seq=ugc1&orientation=portrait"
    },
    {
  ...
  return (
    <section id="testimonials" className="py-16 sm:py-20 lg:py-28 bg-gradient-to-br from-slate-950 via-blue-950 to-purple-950 relative overflow-hidden">
      {/* Background Effects */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        {/* Header */}
        <div className={`text-center mb-12 sm:mb-16 transition-opacity duration-1200 ${mounted ? 'opacity-100' : 'opacity-0'}`}>
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-light text-white mb-4 sm:mb-6 tracking-tight leading-tight px-2">
            Real Sellers, <span className="font-medium bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent">Real Results</span>
          </h2>
          <p className="text-sm sm:text-base lg:text-lg text-blue-200 max-w-2xl mx-auto font-light leading-relaxed px-4">
            When everything was lost, we brought it back. These are their stories.
          </p>
        </div>

        {/* UGC Video Section */}
        <div className={`mb-8 sm:mb-12 transition-opacity duration-1200 delay-200 ${mounted ? 'opacity-100' : 'opacity-0'}`}>
          {/* Video header */}
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h3 className="text-lg sm:text-xl lg:text-2xl font-light text-white mb-3 sm:mb-4 px-2">
              Hear directly from <span className="font-medium text-emerald-400">reinstated sellers</span>
            </h3>
            <p className="text-blue-200 max-w-xl mx-auto px-4 text-xs sm:text-sm leading-relaxed">
              Real customers sharing their success stories after we reinstated their Amazon businesses.
            </p>
          </div>
                ...
                >
                  ...
                  <div className="relative w-28 sm:w-36 lg:w-44 xl:w-48 h-56 sm:h-72 lg:h-88 xl:h-96 mx-auto mb-3 sm:mb-4 overflow-hidden">
                            ...
                            {index === 0 ? (
                              <>
                                ...
                                <style dangerouslySetInnerHTML={{
                                  __html: `wistia-player[media-id='pqfpkp2mst']:not(:defined) { background: center / contain no-repeat url('https://fast.wistia.com/embed/medias/pqfpkp2mst/swatch'); display: block; filter: blur(5px); padding-top:176.39%; }`
                                }} />
                                <wistia-player 
                                  media-id="pqfpkp2mst" 
                              ...
                              <>
                                <script src="https://fast.wistia.com/player.js" async></script>
                                <script src={`https://fast.wistia.com/embed/${video.embedUrl}.js`} async type="module"></script>
                                <style dangerouslySetInnerHTML={{
                    ...
                    <div className="text-center mt-3 sm:mt-4 px-1">
                      <div className="text-white font-medium text-xs sm:text-sm mb-1">{video.title}</div>
                      <div className="text-blue-300 text-xs">{video.customer}</div>
                      <div className="text-blue-400 text-xs hidden sm:block">{video.business}</div>
                    </div>
                  </div>
                </div>
              ))}
        ...
        <div className="relative mt-8 mb-8 h-4">
          ...
          <div className="relative flex justify-center">
            <div className="bg-gradient-to-br from-slate-950 via-blue-950 to-purple-950 px-6 py-1">
              <div className="text-blue-300 text-xs font-medium uppercase tracking-wider">Written Testimonials</div>
            </div>
          </div>
        </div>

        {/* Main Testimonial Display */}
        <div className={`transition-opacity duration-1200 delay-300 ${mounted ? 'opacity-100' : 'opacity-0'}`}>
                  ...
                  <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg border border-white/20 rounded-2xl lg:rounded-3xl p-6 sm:p-8 lg:p-10 hover:bg-white/15 transition-all duration-500 shadow-2xl">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8 lg:mb-10">
                      ...
                      <div className="flex items-center gap-6">
                        <div className="text-center">
                          <div className="text-xl sm:text-2xl font-bold text-emerald-400">{testimonial.revenue}</div>
                          <div className="text-xs text-blue-300 font-medium uppercase tracking-wide">RECOVERED</div>
                        </div>
                        <div className="w-px h-8 bg-white/30"></div>
                        <div className="text-center">
                          <div className="text-xl sm:text-2xl font-bold text-cyan-400">{testimonial.timeframe}</div>
                          <div className="text-xs text-blue-300 font-medium uppercase tracking-wide">TIMEFRAME</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-center mb-8 lg:mb-10">
                      <blockquote className="text-lg sm:text-xl lg:text-2xl text-white font-light leading-relaxed text-center">
                        <span className="text-3xl text-blue-400 opacity-50">&quot;</span>
                        {testimonial.quote}
                        <span className="text-3xl text-blue-400 opacity-50">&quot;</span>
                      </blockquote>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 mb-6">
                      ...
                      <div className="text-center sm:text-left">
                        <div className="text-white font-bold text-lg mb-1">{testimonial.author}</div>
                        <div className="text-blue-300 text-base font-medium">{testimonial.business}</div>
                        <div className="text-blue-400 text-sm">{testimonial.location}</div>
                      </div>
                    </div>
              ...
              {testimonials.map((_, index) => (
                ...
                >
                  <div className={`w-2 h-2 rounded-full ${ 
                    index === activeTestimonial ? 'bg-gray-900' : 'bg-white/60'
                  }`}></div>
