...
export default function Footer() {
  ...
  const footerLinks = [
    ...
    },
    {
      ...
      links: [
        { name: 'Account Suspensions', action: () => scrollToSection('problem') },
        { name: 'Listing Removals', action: () => scrollToSection('problem') },
        { name: 'Frozen Funds', action: () => scrollToSection('problem') },
        { name: 'Emergency Appeals', action: () => scrollToSection('emergency-appeal-form') },
        { name: 'Fast-Track Process', action: () => scrollToSection('process') }
      ]
    },
    {
      title: 'Get Help Now',
      links: [
        { name: 'About Appeal Partners', action: () => window.scrollTo({ top: 0, behavior: 'smooth' }) },
        { name: 'Our Success Rate', action: () => scrollToSection('why-us') },
        { name: 'Client Testimonials', action: () => scrollToSection('testimonials') },
        { name: 'Emergency Contact', action: () => window.location.href = 'tel:+17186684216' },
        { name: 'Start Your Appeal', action: () => scrollToSection('emergency-appeal-form') }
      ]
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="py-16 sm:py-20">
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-12 sm:gap-16 items-start">
            ...
            <div className={`transition-all duration-1200 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              {/* Logo */}
              ...
              <h3 className="text-2xl sm:text-3xl font-light text-white mb-4 sm:mb-6 leading-relaxed">
                Reinstating Amazon & Walmart Sellers<br />
                <span className="font-medium bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">one appeal at a time</span>
              </h3>
              
              <p className="text-gray-400 text-base sm:text-lg leading-relaxed mb-6 sm:mb-8 max-w-lg">
                When Amazon suspends your account, we don&apos;t just write appeals—we wage war for your business survival using insider connections and proven strategies.
              </p>
              ...
              <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20 rounded-xl sm:rounded-2xl p-4 sm:p-6 mb-6 sm:mb-8 backdrop-blur-sm">
                <div className="flex items-center mb-3 sm:mb-4">
                  ...
                  <span className="text-blue-300 font-semibold text-sm sm:text-base">Contact Us</span>
                </div>
                <div className="space-y-2 sm:space-y-3">
                  <div className="flex items-center text-gray-300">
                    <i className="ri-mail-line text-blue-400 text-sm mr-2 sm:mr-3 w-4 h-4 flex items-center justify-center"></i>
                    <a href="mailto:Sales@appealpartners.com" className="hover:text-blue-400 transition-colors cursor-pointer text-sm sm:text-base">
                  ...
                  <div className="flex items-center text-gray-300">
                    ...
                    <a href="tel:+17186684216" className="hover:text-blue-400 transition-colors cursor-pointer text-sm sm:text-base">
                      +1 (718) 668-4216
                    </a>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-3 gap-4 sm:gap-6">
                <div className="text-center">
                  <div className="text-xl sm:text-2xl font-bold text-emerald-400">93%</div>
                  <div className="text-xs text-gray-500 uppercase tracking-wide">Success Rate</div>
                </div>
                <div className="text-center">
                  <div className="text-xl sm:text-2xl font-bold text-blue-400">7 Days</div>
                  <div className="text-xs text-gray-500 uppercase tracking-wide">Avg Resolution</div>
                </div>
                <div className="text-center">
                  <div className="text-xl sm:text-2xl font-bold text-purple-400">$2.7M+</div>
                  <div className="text-xs text-gray-500 uppercase tracking-wide">Funds Recovered</div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-8 sm:space-y-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
                {footerLinks.map((section, index) => (
                  ...
                  >
                    <h4 className="text-white font-semibold mb-4 sm:mb-6 text-base sm:text-lg">{section.title}</h4>
              ...
              <div className="bg-red-500/10 border border-red-500/20 rounded-xl sm:rounded-2xl p-4 sm:p-6 backdrop-blur-sm">
                <div className="flex items-center mb-3 sm:mb-4">
                  ...
                  <span className="text-red-300 font-bold text-sm sm:text-base">Emergency Suspension?</span>
                </div>
                <p className="text-red-200 text-xs sm:text-sm mb-3 sm:mb-4">
                  Every minute counts. Get immediate help from our emergency response team.
                </p>
                <a 
        ...
        <div className="border-t border-gray-800 py-6 sm:py-8">
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 sm:space-y-6 lg:space-y-0">
            ...
            <div className="text-gray-500 text-xs sm:text-sm text-center lg:text-left">
              2024 Appeal Partners. All rights reserved. Amazon suspension recovery specialists.
            </div>
            ...
            <div className="flex items-center space-x-4 sm:space-x-6">
              {socialLinks.map((social, index) => (
                ...
                >
                  <i className={`${social.icon} text-gray-400 group-hover:text-white transition-colors duration-300 text-sm sm:text-base`}></i>
                </Link>
              ))}
            </div>
            ...
            <div className="flex items-center space-x-4 sm:space-x-6 text-xs sm:text-sm">
              <button onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="text-gray-500 hover:text-blue-400 transition-colors duration-300 cursor-pointer">
                Privacy Policy
              </button>
              <Link href="/terms" className="text-gray-500 hover:text-blue-400 transition-colors duration-300 cursor-pointer">
                Terms of Service
              </Link>
              <button onClick={() => scrollToSection('emergency-appeal-form')} className="text-gray-500 hover:text-blue-400 transition-colors duration-300 cursor-pointer">
                Get Help Now
              </button>
            </div>
          </div>
